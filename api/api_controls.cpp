...
bool ChaosEngine::api_controls::setup_api(sol::state &slua)
{
	...
	namespace_controls.set_function("key_down", &ChaosEngine::api_controls::key_down);
	namespace_controls.set_function("look", &ChaosEngine::api_controls::look);

	return true;
}

void ChaosEngine::api_controls::key_down(api_controls::keys key, int ticks)
{
...
void ChaosEngine::api_controls::look(api_controls::directions direction, float amount)
{
