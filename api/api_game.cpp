...
bool ChaosEngine::api_game::setup_api(sol::state &slua)
{
	auto namespace_game = slua["game"].get_or_create<sol::table>();
	/*namespace_game.set_function("get_map_coords", &ChaosEngine::api_game::_api_get_map_coords, this);
...
//sol::table ChaosEngine::api_game::_api_get_map_coords()
//{
