...
namespace ImGui
{
    ...
    IMGUI_API void          TextCentered(const char* Text);                                   //  Wrapper to center text in the content window, Calls ImGui::Text. Could be adjusted to do the same as ImGui::Text but I don't see any real point
    ...
    IMGUI_API bool          CustomSubButton(const char* label, bool isvalid = false, const ImVec2& xsize = ImVec2(0, 0));   // button
    IMGUI_API bool          CustomTopButton(const char* label, bool isvalid = false, const ImVec2& xsize = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          CheckboxCustom(const char* label, bool* v);
