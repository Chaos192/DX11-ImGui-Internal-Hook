...
bool ImGui::CustomSubButton(const char* label, bool isvalid, const ImVec2& xsize)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    ImVec2 size = CalcItemSize(xsize, label_size.x + style.FramePadding.x * 2.0f, label_size.y + style.FramePadding.y * 2.0f);
    ...
    const ImVec4 hover_act = ImVec4(234.f / 255.f, 238.f / 255.f, 178.f / 255.f, 1.f);
    const ImVec4 hover_off = ImVec4(0, 0, 0, 0);


    float deltatime = 5.8f * ImGui::GetIO().DeltaTime;
    ...
    if (isvalid)
        ...
        it_filled->second = clamp(it_filled->second + (2.2f * ImGui::GetIO().DeltaTime * ((isvalid) ? 1.f : -1.f)), 0.0f, 1.f);
    ImU32 col_bg;
    if (isvalid)
    {
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(234.f / 255.f, 238.f / 255.f, 178.f / 255.f, 1), ImVec4(234.f / 255.f, 238.f / 255.f, 178.f / 255.f, it_hover->second.w), it_hover->second.w));
    }

    else
    {
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(1, 1, 1, 1.0f), ImVec4(1, 1, 1, 1.0f), it_hover->second.w));
    }
    // Render
    const ImU32 col = GetColorU32((held && hovered) ? ImGuiCol_ButtonActive : hovered ? ImGuiCol_ButtonHovered : ImGuiCol_Button);
    RenderNavHighlight(bb, id);

    window->DrawList->AddLine(ImVec2(bb.Min.x, bb.Max.y - 5), ImVec2(bb.Max.x, bb.Max.y - 5), GetColorU32(ImVec4{ 1,1,1,0.35 }));
    window->DrawList->AddTriangleFilled(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 4, bb.Max.y - 5), ImVec2(bb.Min.x + (bb.GetWidth() / 2), bb.Max.y - 9), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 4, bb.Max.y - 5), GetColorU32(ImVec4{ 1,1,1,1 }));
    window->DrawList->AddTriangleFilled(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 4, bb.Max.y - 4), ImVec2(bb.Min.x + (bb.GetWidth() / 2), bb.Max.y), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 4, bb.Max.y - 4), GetColorU32(ImVec4{ 1,1,1,1 }));


    //window->DrawList->AddTriangleFilled(ImVec2(), ImVec2(), ImVec2(), GetColorU32(ImVec4{}));
    if (g.LogEnabled)
        LogSetNextTextDecoration("[", "]");

    PushStyleColor(ImGuiCol_Text, col_bg);
...
bool ImGui::CustomTopButton(const char* label, bool isvalid, const ImVec2& xsize)
{
    ...
    ImVec2 pos = window->DC.CursorPos;
    ImVec2 size = ImGui::CalcItemSize(xsize, label_size.x + style.FramePadding.x * 2.0f, label_size.y + style.FramePadding.y * 2.0f);
    ...
    if (isvalid)
    {
        ImGui::RenderFrame(ImVec2(bb.Min.x + ((bb.GetWidth() / 2) * (1 - it_hover->second.w)), bb.Min.y), ImVec2(bb.Max.x - ((bb.GetWidth() / 2) * (1 - it_hover->second.w)), bb.Max.y), GetColorU32(ImVec4{ 1,1,1,(0.10f * it_hover->second.w) }));
        for (int i = 0; i < 5; i++)
        {
            window->DrawList->AddLine(ImVec2(bb.Min.x, bb.Max.y - i), ImVec2(bb.Max.x, bb.Max.y - i), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));
        }

        window->DrawList->AddTriangleFilled(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 4, bb.Max.y - 5), ImVec2(bb.Min.x + (bb.GetWidth() / 2), bb.Max.y - 9), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 4, bb.Max.y - 5), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));
        window->DrawList->AddTriangleFilled(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 4, bb.Max.y - 4), ImVec2(bb.Min.x + (bb.GetWidth() / 2), bb.Max.y), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 4, bb.Max.y - 4), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));

        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - (11 * it_hover->second.w), bb.Max.y + 6), ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 1, bb.Max.y + 6), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }), 2);
        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 2, bb.Max.y + 6), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + (11 * it_hover->second.w), bb.Max.y + 6), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }), 2);

        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 4, bb.Max.y + 10), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 1, bb.Max.y + 15), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));
        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 5, bb.Max.y + 11), ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 2, bb.Max.y + 15), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));
        for (int i = 0; i < 20; i++)
        {
            if (i % 7 == 0)
                window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 2, bb.Max.y + i), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 2, bb.Max.y + i), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }));
        }
        ImGui::PushStyleColor(ImGuiCol_Text, ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,1 });
        ImGui::RenderArrow(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 6.6f, bb.Max.y - 2), ImGuiDir_Down, 0.6f);
        ImGui::PopStyleColor();
        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 2, bb.Max.y + 1), ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 2, bb.Max.y + 19), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }), 1.4f);
        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 1, bb.Max.y), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 1, bb.Max.y + 19), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }), 1.4f);
        window->DrawList->AddLine(ImVec2(bb.Min.x + (bb.GetWidth() / 2) - 1, bb.Max.y + 19), ImVec2(bb.Min.x + (bb.GetWidth() / 2) + 1, bb.Max.y + 19), GetColorU32(ImVec4{ 234.f / 255.f,238.f / 255.f,178.f / 255.f,it_hover->second.w }), 2);
    }
    else
    {
        window->DrawList->AddLine(ImVec2(bb.Min.x, bb.Max.y - 5), ImVec2(bb.Max.x, bb.Max.y - 5), GetColorU32(ImVec4{ 1,1,1,0.35 }));
...
bool ImGui::Toggle(const char* label, bool* v)
{
   ...
   // ImColor uncheck_col = ImColor(42, 42, 42, 255);// GetColorU32(ImGuiCol_FrameBg);
    ...
    window->DrawList->AddRectFilled(newRect.Min, newRect.Max, uncheck_col/*ImColor(52, 61, 70)*/, 10); //  Color
    ...
    window->DrawList->AddRectFilled(sRect.Min, sRect.Max, circle_col/*ImColor(255, 255, 255)*/, 10);  // COLOR

    if (*v) {

        //reset
        window->DrawList->AddRectFilled(ImVec2(newRect.Min.x - 1.f, newRect.Min.y - 1.f), ImVec2(newRect.Max.x + .5f, newRect.Max.y + 1.f), check_col/*ImColor(58, 159, 191)*/, 10); //  COLOR
        ...
        window->DrawList->AddRectFilled(tRect.Min, tRect.Max, circle_col/*ImColor(255, 255, 255)*/, 10);
    }
...
bool ImGui::CheckboxCustom(const char* label, bool* v)
{
    std::string skech_label = "##";
    skech_label += label;
    ...
    const ImVec4 hover_act = ImVec4(121.f / 255.f, 172.f / 255.f, 162.f / 255.f, 1.f);
    const ImVec4 hover_off = ImVec4(0, 0, 0, 0);
    ...
    if (*v)
    {
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(121.f / 255.f, 172.f / 255.f, 162.f / 255.f, it_hover->second.w), ImVec4(121.f / 255.f, 172.f / 255.f, 162.f / 255.f, it_hover->second.w), it_hover->second.w));
    }

    else
    {
        col_bg = ImGui::GetColorU32(ImLerp(ImVec4(1, 1, 1, it_hover->second.w), ImVec4(1, 1, 1, it_hover->second.w), it_hover->second.w));
    }
    for (int i = 0; i < (g.FontSize / 2); i++)
    {
        window->DrawList->AddLine(ImVec2(check_bb.Min.x + 4 + i, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Min.y + 4), col_bg);
        window->DrawList->AddLine(ImVec2(check_bb.Min.x + 4 + i, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Max.y - 4), col_bg);
        window->DrawList->AddLine(ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Min.y + 4), ImVec2(check_bb.Max.x - 4 - i, check_bb.Min.y + (check_bb.GetHeight() / 2)), col_bg);
        window->DrawList->AddLine(ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Max.y - 4), ImVec2(check_bb.Max.x - 4 - i, check_bb.Min.y + (check_bb.GetHeight() / 2)), col_bg);
    }

    window->DrawList->AddLine(ImVec2(check_bb.Min.x, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Min.y), ImGui::GetColorU32(ImVec4{ 1,1,1,1 }), 2);
    window->DrawList->AddLine(ImVec2(check_bb.Min.x, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Max.y), ImGui::GetColorU32(ImVec4{ 1,1,1,1 }), 2);
    window->DrawList->AddLine(ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Min.y), ImVec2(check_bb.Max.x, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImGui::GetColorU32(ImVec4{ 1,1,1,1 }), 2);
    window->DrawList->AddLine(ImVec2(check_bb.Min.x + (check_bb.GetWidth() / 2), check_bb.Max.y), ImVec2(check_bb.Max.x, check_bb.Min.y + (check_bb.GetHeight() / 2)), ImGui::GetColorU32(ImVec4{ 1,1,1,1 }), 2);
    ...
    if (*v)
    {
        ...
        ImGui::RenderCheckMark(window->DrawList, check_bb.Min + ImVec2(pad + 2.8f, pad - 0.8f), ImGui::GetColorU32(ImVec4{ 44.f / 255.f,52.f / 255.f,56.f / 255.f,it_hover->second.w }), square_sz - pad * 2.0f);
    }
    ...
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label, g.LastItemData.StatusFlags | ImGuiItemStatusFlags_Checkable | (*v ? ImGuiItemStatusFlags_Checked : 0));
    //ImGui::ColorEdit4(skech_label.c_str(), col2, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoTooltip | ImGuiColorEditFlags_NoSidePreview);
    return pressed;
}
